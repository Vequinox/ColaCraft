...
public class GuiMixerTier3 extends GuiContainer{

	private static ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/mixer_tier_3_gui.png");
	private final InventoryPlayer player;
	private final TileEntityMixer tileEntity;
	
	public GuiMixerTier3(InventoryPlayer player, TileEntityMixer tileEntity) {
