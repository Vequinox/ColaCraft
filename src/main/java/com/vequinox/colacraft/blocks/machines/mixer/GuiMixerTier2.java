...
public class GuiMixerTier2 extends GuiContainer{

	private static ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/mixer_tier_2_gui.png");
	private final InventoryPlayer player;
	private final TileEntityMixer tileEntity;
	
	public GuiMixerTier2(InventoryPlayer player, TileEntityMixer tileEntity) {
